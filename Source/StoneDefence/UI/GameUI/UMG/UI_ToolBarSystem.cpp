...
//	//当前阶段 04/04
//	GameLevelSurplusQuantity->SetText(FText(FText::FromString(FString::Printf(TEXT("%2d / %2d"), GetGameState()->GetGameData().MaxStagesAreMonsters, GetGameState()->GetGameData().MaxStagesAreMonsters - GetGameState()->GetGameData().PerNumberOfMonsters.Num()))));
//}
//
